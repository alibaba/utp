...
<div class="diagram"><img src="/documentation/assets/diagrams/m-hosted-topology.svg" alt="平台托管拓扑：Seller 经 MP1—MP4 对接 Marketplace，买方经 P1—P6 对接 Marketplace，回调反向推送" style="max-width: 100%; height: auto;"></div>
    <ul>
